<div class="panel panel-info">
  <div class="panel-heading">
    <h3 class="panel-title">EXTENSION Y VÍNCULO</h3>
  </div>
...
<form>
 ...
 <tr id="" class="active">
  ...
  <tr>
    ...
    <tr  id="rw_docencia1">
	<td  colspan="4">
		<textarea class="form-control" id="txt_docencia1"></textarea>
	</td>									
  </tr>
  <tr>
    <td></td>
  ...
  <tr  id="rw_docencia2">
	<td  colspan="4">
		<textarea class="form-control" id="txt_docencia2"></textarea>
	</td>									
  </tr>
   <tr>
    <td></td>
  ...
  <tr  id="rw_docencia3">
	<td  colspan="4">
		<textarea class="form-control" id="txt_docencia3"></textarea>
	</td>									
  </tr>
   <tr id="" class="active">
	<td  colspan="4" >
	<h4>B) Investigación</h4>
	</td>									
   </tr>
   <tr>
    <td></td>
  ...
  <tr  id="rw_investigacion1">
	<td  colspan="4">
		<textarea class="form-control" id="txt_investigacion1"></textarea>
	</td>									
  </tr>
   <tr>
    <td></td>
  ...
  <tr  id="rw_investigacion2">
	<td  colspan="4">
		<textarea class="form-control" id="txt_investigacion2"></textarea>
	</td>									
  </tr>
   <tr>
    <td></td>
  ...
  <tr  id="rw_investigacion3">
	<td  colspan="4">
		<textarea class="form-control" id="txt_investigacion3"></textarea>
	</td>									
  </tr>
    <tr>
    <td></td>
  ...
  <tr  id="rw_investigacion4">
	<td  colspan="4">
		<textarea class="form-control" id="txt_investigacion4"></textarea>
	</td>									
  </tr>
    <tr>
    <td></td>
  ...
  <tr  id="rw_investigacion5">
	<td  colspan="4">
		<textarea class="form-control" id="txt_investigacion5"></textarea>
	</td>									
  </tr>
    <tr>
    <td></td>
	...
	<td  colspan="4">
		<textarea class="form-control" id="txt_investigacion6"></textarea>
	</td>									
  </tr>
	<tr id="" class="active">
	<td  colspan="4">
  ...
  <tr  id="rw_extension1">
	<td  colspan="4">
		<textarea class="form-control" id="txt_extension1"></textarea>
	</td>									
  </tr>
   <tr>
    <td></td>
   ...
   <tr  id="rw_extension2">
	<td  colspan="4">
		<textarea class="form-control" id="txt_extension2"></textarea>
	</td>									
  </tr>
   <tr>
    <td></td>
  ...
  nacionales, internacionales. </td>
   ...
   <tr  id="rw_extension3">
	<td  colspan="4">
		<textarea class="form-control" id="txt_extension3"></textarea>
	</td>									
  </tr>
    <tr>
    <td></td>
   ...
   <tr  id="rw_extension4">
	<td  colspan="4">
		<textarea class="form-control" id="txt_extension4"></textarea>
	</td>									
  </tr>
    <tr>
    <td></td>
   ...
   <tr  id="rw_extension5">
	<td  colspan="4">
		<textarea class="form-control" id="txt_extension5"></textarea>
	</td>									
  </tr>
    <tr>
    <td></td>
   ...
   <tr  id="rw_extension6">
	<td  colspan="4">
		<textarea class="form-control" id="txt_extension6"></textarea>
	</td>									
  </tr>
   <tr>
    <td></td>	
   ...
   <tr  id="rw_extension7">
	<td  colspan="4">
		<textarea class="form-control" id="txt_extension7"></textarea>
	</td>									
  </tr>
</table> 
</form>
